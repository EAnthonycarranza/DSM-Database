...
const JWT_SECRET = process.env.JWT_SECRET || "dsm-default-secret-change-me";
...
const authLimiter = rateLimit({
  windowMs: 15 * 60 * 1000, // 15 minutes
  max: 50,
  message: { success: false, error: "Too many login/reset attempts, please try again later." },
  standardHeaders: true,
  legacyHeaders: false,
});
...
let corsOrigin = corsEnv ? corsEnv.split(",").map((s) => s.trim()).filter(Boolean) : true;

// Aggressively allow local development origins in non-production or if explicitly requested
if (process.env.NODE_ENV !== 'production' && Array.isArray(corsOrigin)) {
  corsOrigin.push("http://localhost:3000");
  corsOrigin.push("http://127.0.0.1:3000");
  corsOrigin.push("http://localhost:4000");
  corsOrigin.push("http://127.0.0.1:4000");
}
...
// Prevent NoSQL Injection by sanitizing all inputs
...
async function ensureMongoSeed() {
  try {
    const events = await dbList("events");
    if (events.length === 0) {
      console.log("Seeding recurring calendar events...");
...
async function seedRecurringEvents() {
  const schedule = [
    // MONDAY - Squad A
    { title: "Wake-Up/Make Beds/Tidy Rooms", start: "06:30", end: "07:30", days: ["MO"], cat: "default" },
    { title: "Breakfast Squad A", start: "07:30", end: "08:00", days: ["MO"], cat: "default" },
    { title: "A.C.T.S. Declarations & Solitude", start: "08:15", end: "09:00", days: ["MO"], cat: "class" },
    { title: "Strategies for Recovery", start: "09:30", end: "10:30", days: ["MO"], cat: "class" },
    { title: "In Search of Timothy / Servant Leaders", start: "11:00", end: "12:30", days: ["MO"], cat: "class" },
    { title: "Lunch (SQUAD A)", start: "13:00", end: "13:30", days: ["MO"], cat: "default" },
    { title: "Food and Nutrition Education", start: "14:30", end: "15:30", days: ["MO"], cat: "class" },
    { title: "Bible Study Q&A", start: "16:00", end: "17:00", days: ["MO"], cat: "meeting" },
    { title: "Dinner (SQUAD A)", start: "18:00", end: "18:30", days: ["MO"], cat: "default" },
    { title: "Our Father who ART in Heaven", start: "19:10", end: "20:15", days: ["MO"], cat: "meeting" },
    { title: "Indoors/Bed count", start: "21:45", end: "22:00", days: ["MO"], cat: "default" },

    // TUESDAY - Squad B
    { title: "Wake up/Make Beds/Tidy Rooms", start: "07:00", end: "07:30", days: ["TU"], cat: "default" },
    { title: "Breakfast Squad B", start: "07:30", end: "08:00", days: ["TU"], cat: "default" },
    { title: "A.C.T.S. Declarations & Solitude", start: "08:15", end: "09:00", days: ["TU"], cat: "class" },
    { title: "Anger Management", start: "09:30", end: "10:30", days: ["TU"], cat: "class" },
    { title: "The Sheppard's Staff", start: "11:00", end: "12:30", days: ["TU"], cat: "class" },
    { title: "Lunch (SQUAD B)", start: "13:00", end: "13:30", days: ["TU"], cat: "default" },
    { title: "Wellness Center/ PT", start: "14:30", end: "17:30", days: ["TU"], cat: "default" },
    { title: "Dinner (SQAUD B)", start: "18:00", end: "18:30", days: ["TU"], cat: "default" },
    { title: "Pier Support/ Evangelism", start: "19:15", end: "20:15", days: ["TU"], cat: "meeting" },
    { title: "In Rooms Ready for Bed", start: "21:45", end: "22:00", days: ["TU"], cat: "default" },

    // WEDNESDAY - Squad C
    { title: "Wake up/Make Beds/Tidy Rooms", start: "07:00", end: "07:30", days: ["WE"], cat: "default" },
    { title: "Breakfast/Psalm 119:11 SQAUD C", start: "07:30", end: "08:00", days: ["WE"], cat: "default" },
    { title: "Rom 8:26 Declarations & Victory Laps", start: "08:15", end: "09:00", days: ["WE"], cat: "class" },
    { title: "Food & Education / Kitchen prep", start: "09:30", end: "10:30", days: ["WE"], cat: "class" },
    { title: "Exploring the Deep New Believers Doctrine", start: "11:00", end: "12:30", days: ["WE"], cat: "class" },
    { title: "Lunch Squad C", start: "13:00", end: "13:30", days: ["WE"], cat: "default" },
    { title: "Double Scrub Squad Breakout", start: "14:30", end: "17:30", days: ["WE"], cat: "default" },
    { title: "Dinner Squad C", start: "18:00", end: "18:30", days: ["WE"], cat: "default" },
    { title: "Bible Study/Prayer", start: "19:15", end: "20:15", days: ["WE"], cat: "meeting" },
    { title: "In Rooms Ready for Bed", start: "21:45", end: "22:00", days: ["WE"], cat: "default" },

    // THURSDAY - Squad A
    { title: "Wake up/Make Beds/Tidy Rooms", start: "05:45", end: "06:30", days: ["TH"], cat: "default" },
    { title: "Depart for Oak Hills Church", start: "06:30", end: "07:00", days: ["TH"], cat: "default" },
    { title: "Men’s Bible Study/Fellowship", start: "07:00", end: "08:30", days: ["TH"], cat: "meeting" },
    { title: "Breakfast Squad A", start: "09:00", end: "09:30", days: ["TH"], cat: "default" },
    { title: "Dr.Carl William believeing the bible", start: "10:00", end: "11:30", days: ["TH"], cat: "class" },
    { title: "Lunch Squad A", start: "13:00", end: "13:30", days: ["TH"], cat: "default" },
    { title: "Service work/ Directors discretion", start: "14:30", end: "17:30", days: ["TH"], cat: "default" },
    { title: "Dinner Squad A", start: "18:00", end: "18:30", days: ["TH"], cat: "default" },
    { title: "Portraits of Leadership", start: "19:00", end: "20:30", days: ["TH"], cat: "class" },
    { title: "DSM Phase 1 Leader meeting", start: "20:30", end: "21:00", days: ["TH"], cat: "meeting" },
    { title: "In Rooms Ready for Bed", start: "22:30", end: "23:00", days: ["TH"], cat: "default" },

    // FRIDAY - Squad B
    { title: "Wake up/Make Beds/Tidy Rooms", start: "07:00", end: "07:30", days: ["FR"], cat: "default" },
    { title: "Breakfast Squad B", start: "07:30", end: "08:00", days: ["FR"], cat: "default" },
    { title: "SOAP Declarations & Solitude", start: "08:15", end: "08:30", days: ["FR"], cat: "class" },
    { title: "Relapse prevention", start: "09:30", end: "10:30", days: ["FR"], cat: "class" },
    { title: "The Bait of Satan", start: "11:00", end: "12:30", days: ["FR"], cat: "class" },
    { title: "Lunch Squad B", start: "13:00", end: "13:30", days: ["FR"], cat: "default" },
    { title: "P Support/ NA,AA Just for today", start: "14:30", end: "16:00", days: ["FR"], cat: "meeting" },
    { title: "Dinner Squad B", start: "18:00", end: "18:30", days: ["FR"], cat: "default" },
    { title: "Head Count", start: "22:00", end: "22:15", days: ["FR"], cat: "default" },
    { title: "In Rooms Ready for Bed", start: "23:45", end: "23:59", days: ["FR"], cat: "default" },

    // SATURDAY - Squad C
    { title: "Wake up/Make beds/Tidy Rooms", start: "08:00", end: "08:30", days: ["SA"], cat: "default" },
    { title: "Breakfast (Phase 2) Squad C", start: "08:30", end: "09:00", days: ["SA"], cat: "default" },
    { title: "The Structure of the home", start: "09:15", end: "10:15", days: ["SA"], cat: "class" },
    { title: "Directors Discretion / Assignments", start: "10:30", end: "12:00", days: ["SA"], cat: "default" },
    { title: "Lunch Squad C", start: "13:00", end: "13:45", days: ["SA"], cat: "default" },
    { title: "Evangelism/Outreach/Family", start: "14:00", end: "18:00", days: ["SA"], cat: "meeting" },
    { title: "Dinner Squad C", start: "18:00", end: "18:45", days: ["SA"], cat: "default" },
    { title: "Family Evening", start: "19:00", end: "23:45", days: ["SA"], cat: "default" },
    { title: "In Rooms Ready for Bed", start: "23:45", end: "23:59", days: ["SA"], cat: "default" },

    // SUNDAY - Royal Rumble
    { title: "Wake Up/ Make Beds/Tidy Rooms", start: "08:00", end: "09:00", days: ["SU"], cat: "default" },
    { title: "Doer's of the word @ SACC", start: "09:00", end: "10:00", days: ["SU"], cat: "meeting" },
    { title: "Prayer @ SACC", start: "10:15", end: "10:45", days: ["SU"], cat: "meeting" },
    { title: "General Assembly @ SACC", start: "11:00", end: "12:15", days: ["SU"], cat: "meeting" },
    { title: "Family Visitation Phone Calls", start: "13:00", end: "17:00", days: ["SU"], cat: "default" },
    { title: "Dinner", start: "18:00", end: "18:45", days: ["SU"], cat: "default" },
    { title: "Family meeting/Phase 2 meeting", start: "19:00", end: "20:00", days: ["SU"], cat: "meeting" },
    { title: "Solitude/PT’s/Movies/Rest", start: "20:00", end: "21:45", days: ["SU"], cat: "default" },
    { title: "In Rooms Ready for Bed", start: "21:45", end: "22:00", days: ["SU"], cat: "default" },
  ];
...
async function dbInsert(store, rec) {
  ...
  if (store === "users") {
    ...
    if (doc.password && !doc.password.startsWith("$2a$")) { // Simple check for bcrypt hash
      doc.password = await bcrypt.hash(String(doc.password), BCRYPT_SALT_ROUNDS);
    }
  }
  if (USE_MONGO) {
    try {
...
async function dbUpdate(store, id, patch) {
  ...
  if (store === "users" && update.password && !update.password.startsWith("$2a$")) {
    update.password = await bcrypt.hash(String(update.password), BCRYPT_SALT_ROUNDS);
  }
  if (USE_MONGO) {
    try {
      if (store === "settings") {
...
app.post(`${API_PREFIX}/auth/login`, async (req, res) => {
  try {
    ...
    const identifier = em || un;
    if (!identifier) {
      return res.status(400).json({ success: false, error: "Email or username is required" });
    }

    // --- User lookup (find by identifier, then verify password separately) ---
    let user = null;

    if (USE_MONGO) {
      try {
        const col = mongoDb.collection("users");
        const identEscaped = identifier.replace(/[.*+?^${}()|[\]\\]/g, "\\$&");
        
        // 1) Try exact match first (very fast indexed lookup)
        user = await col.findOne({ $or: [{ email: identifier }, { username: identifier }] });
        
        // 2) Fallback to case-insensitive match if not found
        if (!user) {
          user = await col.findOne({
            $or: [
              { email: { $regex: `^${identEscaped}$`, $options: "i" } },
              { username: { $regex: `^${identEscaped}$`, $options: "i" } },
            ],
          });
        }
      } catch (e) {
    ...
    // Fallback to file DB (also used when Mongo doesn't find the user)
    if (!user) {
      const db = await ensureDb();
      user = (db.users || []).find((u) => {
        const byEmail = String(u.email || "").toLowerCase() === identifier;
        const byUser = String(u.username || "").toLowerCase() === identifier;
        return byEmail || byUser;
      });
    }

    // Verify password separately (consistent for both Mongo and file DB)
    ...
    if (tf.enabled) {
      ...
      const backupStr = String(backupCode || "").trim();
      const hasOtp = /^\d{6}$/.test(otpStr);
      const hasBackup = backupStr.length >= 8;

      // No code provided at all — tell client 2FA is required
      if (!hasOtp && !hasBackup) {
      ...
      // Try backup code if TOTP didn't pass
      if (!verified && hasBackup && Array.isArray(tf.backupCodes)) {
        const normalized = backupStr.replace(/[\s-]+/g, "").toUpperCase();
        ...
        if (idx >= 0) {
          ...
          const updatedTF = { ...tf };
          // Single atomic update for both stores
          await dbUpdate("users", user.id, { twoFactor: updatedTF });
          user.twoFactor = updatedTF;
        }
      }
    ...
    res.json({ success: true, user: sanitizeUser(fresh), token });
  } catch (error) {
...
app.get(`${API_PREFIX}/students`, async (req, res) => {
  try {
    ...
    if (req.user.role !== "admin") {
      out = out.filter(s => s.id === req.user.studentId);
    }
    res.json(out);
  } catch (error) {
...
app.post(`${API_PREFIX}/students`, authorizeRole(["admin"]), async (req, res) => {
  try {
    const body = req.body || {};
...
app.post(`${API_PREFIX}/students/:id/credentials`, authorizeRole(["admin"]), async (req, res) => {
  try {
...
app.put(`${API_PREFIX}/students/:id`, authorizeRole(["admin"]), async (req, res) => {
  try {
    const { id } = req.params;
    const body = req.body || {};
...
app.delete(`${API_PREFIX}/students/:id`, authorizeRole(["admin"]), async (req, res) => {
  try {
    const { id } = req.params;
...
app.get(`${API_PREFIX}/documents`, async (req, res) => {
  try {
    ...
    if (req.user.role !== "admin") {
      // Students can ONLY see their own documents, regardless of query param
      out = out.filter((d) => String(d.studentId || "") === String(req.user.studentId));
    } else if (studentId) {
      out = out.filter((d) => String(d.studentId || "") === String(studentId));
    }
...
app.delete(`${API_PREFIX}/documents/:id`, async (req, res) => {
  try {
    ...
    // IDOR protection
    if (req.user.role !== "admin" && String(doc.studentId || "") !== String(req.user.studentId)) {
...
app.get(`${API_PREFIX}/envelopes`, async (req, res) => {
  try {
    ...
    if (req.user.role !== "admin") {
      // Filter for envelopes where user is a recipient
      list = list.filter((env) => {
        ...
        return recips.some((r) => 
          ...
          (studentId && String(r.studentId || r.id || "") === String(studentId))
        );
      });
    } else {
      // Admins can filter by query
...
app.get(`${API_PREFIX}/envelopes/:id`, async (req, res) => {
  try {
    ...
    if (req.user.role !== "admin") {
      const recips = Array.isArray(env.recipients) ? env.recipients : [];
      const isRecip = recips.some((r) => 
        (req.user.id && String(r.userId || "") === String(req.user.id)) || 
        (req.user.studentId && String(r.studentId || r.id || "") === String(req.user.studentId))
      );
      if (!isRecip) return res.status(403).json({ error: "Forbidden: Access denied" });
    }
...
app.post(`${API_PREFIX}/envelopes`, authorizeRole(["admin"]), async (req, res) => {
  try {
    const body = req.body || {};
    const now = Date.now();
...
app.post(`${API_PREFIX}/envelopes/:id/recipient/:rid/status`, async (req, res) => {
  try {
    ...
    // IDOR protection
    if (req.user.role !== "admin") {
      const isSelf = String(rid) === String(req.user.id) || String(rid) === String(req.user.studentId);
      if (!isSelf) return res.status(403).json({ error: "Forbidden: You can only update your own status" });
    }
    const recips = Array.isArray(env.recipients) ? env.recipients : [];
...
app.post(`${API_PREFIX}/envelopes/:id/submit`, async (req, res) => {
  try {
    ...
    // IDOR protection
    if (req.user.role !== "admin") {
      const isSelf = (studentId && String(studentId) === String(req.user.studentId)) || (recipientId && String(recipientId) === String(req.user.id));
      if (!isSelf) return res.status(403).json({ success: false, error: "Forbidden: You can only submit for yourself" });
      
      const recips = Array.isArray(env.recipients) ? env.recipients : [];
      const isRecip = recips.some(r => String(r.userId || "") === String(req.user.id) || String(r.studentId || r.id || "") === String(req.user.studentId));
      if (!isRecip) return res.status(403).json({ success: false, error: "Forbidden: You are not a recipient of this envelope" });
    }
    const recips = Array.isArray(env.recipients) ? env.recipients : [];
    ...
    const next = { 
      ...
      status: "in-progress", 
      updatedAt: now,
      lastPdfUrl: uploaded.url || env.lastPdfUrl 
    };

    // If all recipients completed, mark envelope completed and add to student's documents
    const allDone = recips.every((r) => String(r.status || "").toLowerCase() === "completed");
    let docRec = null;
    if (allDone) {
      next.status = "completed";
      if (studentId && uploaded.url) {
        try {
          ...
          // Update the last recipient with the documentId too
          recips[idx].documentId = docRec.id;
        } catch (e) {
          console.error("Failed to insert final signed document record:", e);
        }
      }
    }
    const saved = await dbUpdate("envelopes", id, next);
...
app.get(`${API_PREFIX}/forms/:id/submissions`, authorizeRole(["admin"]), async (req, res) => {
  try {
    const { id } = req.params;
...
app.post(`${API_PREFIX}/forms`, authorizeRole(["admin"]), async (req, res) => {
  try {
    const body = req.body || {};
...
app.put(`${API_PREFIX}/forms/:id`, authorizeRole(["admin"]), async (req, res) => {
  try {
    const { id } = req.params;
    const body = req.body || {};
...
app.delete(`${API_PREFIX}/forms/:id`, authorizeRole(["admin"]), async (req, res) => {
  try {
    const { id } = req.params;
...
app.get(`${API_PREFIX}/forms/:id/export`, authorizeRole(["admin"]), async (req, res) => {
  try {
    const { id } = req.params;
...
// GET /messages — only return messages visible to that user
app.get(`${API_PREFIX}/messages`, async (req, res) => {
  try {
    const userId = req.user.id;
    const list = await dbList("messages");
    const out = (Array.isArray(list) ? list : []).filter((m) => {
      if (req.user.role === "admin") return true;
      return messageVisibleTo(m, userId);
    });
    res.json(out);
  } catch (error) {
...
// GET /notifications — only return global or targeted to that user
...
app.get(`${API_PREFIX}/:store`, async (req, res) => {
  try {
    ...
    // Admin-only stores
    const adminOnlyStores = ["users", "audit", "settings", "budget", "donations"];
    if (adminOnlyStores.includes(store) && req.user.role !== "admin") {
    ...
    // For students: students and documents should be filtered if they are not admin?
    // Actually, students might need to see their own student record.
    ...
    if (req.user.role !== "admin") {
      if (store === "students") {
        ...
        out = out.filter(d => d.studentId === req.user.studentId);
      } else if (store === "envelopes") {
        out = out.filter(env => (env.recipients || []).some(r => r.userId === req.user.id || r.studentId === req.user.studentId));
      }
    }
...
app.get(`${API_PREFIX}/:store/:id`, async (req, res) => {
  try {
    ...
    if (store === "messages") {
      ...
      const forId = req.user.id;
      if (req.user.role !== "admin" && !messageVisibleTo(item, forId)) {
    ...
    const adminOnlyStores = ["users", "audit", "settings", "budget", "donations"];
    if (adminOnlyStores.includes(store) && req.user.role !== "admin") {
      // Allow users to get their own user profile
      if (store === "users" && id === req.user.id) {
        // proceed
      } else {
        return res.status(403).json({ error: "Forbidden: Admin access required" });
      }
    ...
    if (req.user.role !== "admin") {
      if (store === "students" && item.id !== req.user.studentId) {
        return res.status(403).json({ error: "Forbidden: Access to other students is denied" });
      }
      if (store === "documents" && item.studentId !== req.user.studentId) {
        return res.status(403).json({ error: "Forbidden: Access to other students' documents is denied" });
      }
      if (store === "envelopes") {
        const isRecip = (item.recipients || []).some(r => r.userId === req.user.id || r.studentId === req.user.studentId);
        if (!isRecip) return res.status(403).json({ error: "Forbidden: You are not a recipient of this envelope" });
      }
    }
...
app.post(`${API_PREFIX}/:store`, async (req, res) => {
  try {
    ...
    if (req.user.role !== "admin") {
      const allowedStudentStores = ["messages", "formSubmissions", "notifications", "notes", "tasks"];
      if (!allowedStudentStores.includes(store)) {
        return res.status(403).json({ error: "Forbidden: Admin access required to create this resource" });
      }
    }
...
app.put(`${API_PREFIX}/:store/:id`, async (req, res) => {
  try {
    ...
    if (body.id && String(body.id) !== String(id)) {
      return res.status(400).json({ error: "Changing item ID is not allowed" });
    }
    
    // Role-based write protection
    if (req.user.role !== "admin") {
      const allowedStudentUpdateStores = ["messages", "notifications", "tasks"];
      if (!allowedStudentUpdateStores.includes(store)) {
        // Special case: allow users to update their own profile (e.g. name, but not role)
        if (store === "users" && id === req.user.id) {
          delete body.role; // Prevent role escalation
          delete body.studentId;
        } else {
          return res.status(403).json({ error: "Forbidden: Admin access required to update this resource" });
        }
      } else {
        // IDOR check for messages/tasks/notifications
        const item = await dbGet(store, id);
        if (item) {
          if (store === "messages" && !messageVisibleTo(item, req.user.id)) return res.status(403).json({ error: "Forbidden" });
          if (store === "tasks" && item.studentId !== req.user.studentId) return res.status(403).json({ error: "Forbidden" });
          if (store === "notifications" && item.to && String(item.to) !== req.user.id) return res.status(403).json({ error: "Forbidden" });
        }
      }
    }
...
// Bulk Update / Replace (Admin only)
app.post(`${API_PREFIX}/:store/bulk`, authorizeRole(["admin"]), async (req, res) => {
  try {
...
app.delete(`${API_PREFIX}/:store/:id`, async (req, res, next) => {
  ...
  try {
    ...
    // Role-based protection: only admins can delete, or users deleting their own messages?
    // For now, let's keep deletion admin-only for safety.
    if (req.user.role !== "admin") {
      return res.status(403).json({ error: "Forbidden: Admin access required to delete resources" });
    }
...
app.use((req, res, next) => {
  ...
  if (hasBuild) {
    ...
    // If no build, provide a helpful message for developers
    if (process.env.NODE_ENV !== 'production') {
      res.status(404).send(`
        <h3>Frontend Build Not Found</h3>
        <p>The backend is running, but the React build folder was not found at <code>${buildPath}</code>.</p>
        <p>To fix this:</p>
        <ol>
          <li>Run <code>npm run build</code> in the <code>client</code> folder.</li>
          <li>OR start the React dev server with <code>npm start</code> in the <code>client</code> folder and ensure the iOS app is pointing to port 3000.</li>
        </ol>
      `);
    } else {
      res.status(404).json({ error: "Frontend build missing" });
    }
  }
});
...
server.listen(PORT, async () => {
  try {
    ...
    // Seed schedule for either DB type if empty
